---
name: docx-handbook-decorate
description: 为 Word 科普手册 / 活动手册 / 研学手册 / 社区宣传册批量添加手绘卡通风装饰元素（云朵、灯泡、IP 形象、绿植、星星人等）与科普海报插图，生成统一视觉风格的「装饰版」docx。当用户提供一份 docx 文档 + 一批装饰素材（webp / gif / png）并要求「加装饰 / 美化 / 加海报 / 做成可爱风 / 青少年科普风 / 亲子风」时使用。也可用于把纯文字手册改造成带插画、图标化、少大段文字的阅读友好版本。
---
